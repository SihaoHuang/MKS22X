public class ExpressionTree{
  ...
  public String toString(){
    if(hasChildren()) return "(" + getLeft().toString() + " " + getOp() + " " + getRight().toString() + ")";
  ...
  public String toStringPostfix(){
    if(hasChildren()) return getLeft().toStringPostfix() + " " + getRight().toStringPostfix() + " " + getOp();
    else return Double.toString(value);
  }
  ...
  public String toStringPrefix(){
    if(hasChildren()) return  getOp() + " " + getLeft().toStringPrefix() + " " + getRight().toStringPrefix();
    else return Double.toString(value);
  }
